...
class Recibo(Entity):
    ...
    using_options(tablename='recibo_ceiba')
...
class Venta(Entity):
    ...
    using_options(tablename='venta_ceiba')
...
class Alquiler(Entity):
    ...
    inquilino = Field(Unicode(255), default=None)
    recibo = ManyToOne('Recibo')
...
class Visit(Entity):
    ...
    """
    using_options(tablename='visit_ceiba')
...
class VisitIdentity(Entity):
    ...
    """
    using_options(tablename='visit_identity_ceiba')
